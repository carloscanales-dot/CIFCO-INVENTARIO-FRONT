<template>
    <div>
            ...
            <VCardText>
                <VRow dense>
                    ...
                    <VCol cols="12" lg="12">
                        ...
                        <VRow dense>
                            <VCol cols="12" md="3" v-if="isPermission('register_product')">
                                <VBtn block color="primary" @click="router.push({ name: 'product-add' })">
                                    Nuevo producto
                                    <VIcon end icon="ri-product-hunt-fill" />
                                </VBtn>
                            </VCol>
                    ...
                    <tbody class="table-body">
                        <tr v-for="item in list_products" :key="item.id" class="table-row">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="stock-status">
                                            <VChip size="small" :color="getStockColor(item.state_stock)"
                                                class="stock-chip">
                            ...
                            <td class="status-cell">
                                <VChip size="small" :color="item.state == 1 ? 'success' : 'error'" class="status-chip">
                            ...
                            <td class="actions-cell">
                                <div class="action-buttons">
                                    <IconBtn size="small" class="action-btn edit-btn" @click="editItem(item)"
                                        v-if="isPermission('edit_product')">
                                        <VIcon icon="ri-pencil-line" />
                                    </IconBtn>
                                    <IconBtn size="small" class="action-btn delete-btn" @click="deleteItem(item)"
        ...
        <ImportExcelProduct v-model:isDialogVisible="isImportExcelProductDialogVisible"
            @importExcelProduct="importProducts()"></ImportExcelProduct>
        <ProductDeleteDialog v-if="product_selected_delete && isProductDeleteDialogVisible"
            v-model:isDialogVisible="isProductDeleteDialogVisible" :productSelected="product_selected_delete"
            @deleteProduct="addDeleteProduct"></ProductDeleteDialog>
    </div>
</template>
