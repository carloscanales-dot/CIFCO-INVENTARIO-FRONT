...
<template>
    <div>
        ...
        <VRow>
            ...
            <VCol cols="12">
                <VCard class="mb-6" title="Producto Ingresado">
                    <VCardText>
                        <VRow dense>
                            <!-- PRODUCTO -->
                            <VCol cols="12" md="7">
                                <VAutocomplete v-model="select_product" v-model:search="search_product"
                                    ...
                                    label="Ingrese código de producto" placeholder="Buscar producto" variant="outlined"
                                ...
                                <VRow dense>
                                    <VCol cols="12" md="4">
                                        <VSelect v-model="unit_id" :items="units" item-title="name" item-value="id"
                                            label="Unidades" variant="outlined" />
                                    </VCol>

                                    <VCol cols="12" md="4">
                                        <VTextField v-model="price_unit" label="Precio" type="number"
                                            variant="outlined" />
                                    </VCol>

                                    <VCol cols="12" md="4">
                                        <VTextField v-model="quantity" label="Cantidad" type="number"
                                            variant="outlined" />
                                    </VCol>
                    ...
                    <VCardText>
                        ...
                        <VTable density="comfortable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-end">Precio Unitario</th>
                                    <th class="text-uppercase text-end">Cantidad</th>
                                    <th class="text-uppercase text-end">Total</th>
                            ...
                            <tbody>
                                <tr v-for="(purchase_detail, index) in purchase_details" :key="index">
                                    ...
                                    <td class="text-end">$. {{ purchase_detail.price_unit }}</td>
                                    <td class="text-end">{{ purchase_detail.quantity }}</td>
                                    <td class="text-end">$. {{ purchase_detail.total }}</td>
                        ...
                        <VRow justify="end" dense>
                            <VCol cols="12" sm="6" md="4">
                                <VTextField v-model="importe" label="Importe" type="number" variant="outlined"
                                    density="comfortable" />
                            </VCol>

                            <VCol cols="12" sm="6" md="4">
                                <VTextField v-model="igv" label="IVA" type="number" variant="outlined"
                                    density="comfortable" />
                            </VCol>

                            <VCol cols="12" sm="6" md="4">
                                <VTextField v-model="total" label="Total" type="number" variant="outlined"
                                    density="comfortable" />
                            </VCol>
                        </VRow>
                    </VCardText>
