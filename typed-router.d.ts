...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'dispatches-add': RouteRecordInfo<'dispatches-add', '/dispatches/add', Record<never, never>, Record<never, never>>,
    'dispatches-edit-id': RouteRecordInfo<'dispatches-edit-id', '/dispatches/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'dispatches-list': RouteRecordInfo<'dispatches-list', '/dispatches/list', Record<never, never>, Record<never, never>>,
    'inventory-list': RouteRecordInfo<'inventory-list', '/inventory/list', Record<never, never>, Record<never, never>>,
